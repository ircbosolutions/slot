...
const Orqs2 = () => {
    ...
    const getOrqsData=()=>{
        ...
        Axios.get(`http://localhost:3002/getorqsquesdata2/${courseid}`).then((response)=>{
    ...
    const orqsData=(e)=>{
        ...
        Axios.put('http://localhost:3002/sendusrorqsdata2',{
            uid:getUid,
            q1:q1,
            ans1:ans1,
            q2:q2,
        ...
        <>
            <div className="orqs-big-container-full">
                ...
                <div className="orqs-container-full">
                    ...
                    <textarea  maxLength='500' minLength='20' placeholder='Enter Your Answer Here' name="" id="" cols="100" rows="5" onChange={(e)=>{
